...
protected:
    ...
    TextBox *mHierarchyLevelBox, *mScaleBox, *mCreaseAngleBox, *mAdaptivityBox;
    TextBox *mOrientationSingularityBox, *mPositionSingularityBox, *mSmoothBox;
    Slider *mScaleSlider, *mCreaseAngleSlider, *mSmoothSlider, *mAdaptivitySlider;
    CheckBox *mFilterSingularitiesBox;
    Float mAdaptivity;
